...
const manageNotice = require('./manage/notice.js')
...
router.get('/dogAdmin/notice/list', manageNotice.getList)
router.post('/dogAdmin/notice/update', manageNotice.updateInfo)
router.post('/dogAdmin/notice/remove', manageNotice.removeRecord)
router.post('/dogAdmin/notice/send', manageNotice.send)
